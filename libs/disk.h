...
// thanks osdev, but writing methods are completely mine and the LBA
// the writing methods are mine because → i writed them
// even i writed this while i saw the OSDEV documentation
// i improved this to make easier for me
